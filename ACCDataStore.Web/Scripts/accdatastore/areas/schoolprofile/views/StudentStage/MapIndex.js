...
function ShowPopupInfo(data) {
    ...
    var sInformation = "<h3 align='center'> Student Stage - " + data.dataTitle + "</h3>";
    sInformation += "<table class='style2'>";
    sInformation += "<thead><tr><th>Stages</th><th>Female</th><th>Male</th><th>Total</th></tr></thead>";
    sInformation += "<tbody>";
    if (data.dataSeries.length != 0) {
        for (var i = 0; i < data.dataSeries.length; i++) {
            sInformation += "<tr><td>" + data.dataSeries[i].StageCode + "</td><td  align='center'>" + data.dataSeries[i].PercentageFemaleAllSchool.toFixed(2) + "</td><td  align='center'>" + data.dataSeries[i].PercentageMaleAllSchool.toFixed(2) + "</td><td  align='center'>" + data.dataSeries[i].PercentageAllSchool.toFixed(2) + "</td><tr>";
