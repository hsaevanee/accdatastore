...
function ShowPopupInfo(data, sName) {
    ...
    if (data.length != 0) {
        for (var i = 0; i < data.length; i++) {
            sInformation += "<tr><td>" + data[i].StageCode + "</td><td  align='center'>" + data[i].PercentageFemaleAllSchool.toFixed(2) + "</td><td  align='center'>" + data[i].PercentageMaleAllSchool.toFixed(2) + "</td><td  align='center'>" + data[i].PercentageAllSchool.toFixed(2) + "</td><tr>";
