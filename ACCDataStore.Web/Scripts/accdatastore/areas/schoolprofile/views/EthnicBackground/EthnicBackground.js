...
$(function () {
    ...
    $('#buttonGetData').click(function () {
       // alert('CheckAll check');
        //if (validateCheckBoxs() == true) {
        //    alert('CheckAll check');
        //    getEthnicData(mSchCriteriaParams);
        //}
        $('#formSchoolCriteria').submit();
    });
});
...
function getEthnicData(mSchCriteriaParams) {
    $.ajax({
        type: 'POST',        
        url: sContextPath + 'SchoolProfile/EthnicBackground/GetEthnicityData',
        data: JSON.stringify(mSchCriteriaParams),
